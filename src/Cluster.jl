...
This function clusters the data using the K-Means algorithm. This method calls the helper function corresponding to the algorithm passed in as an argument. 
